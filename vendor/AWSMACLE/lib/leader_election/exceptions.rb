    ...
    module EB
        module LeaderElection
            module Errors
                ...
                class NilAttributeException < RuntimeError; end
                class SchedulerAlreadyRunningException < RuntimeError; end
                class SchedulerAlreadyStoppedException < RuntimeError; end
                class DaemonAlreadyRunningException < RuntimeError; end
                class DaemonAlreadyStoppedException < RuntimeError; end
            end
